...
public:
  static Solver::PartialValidity negatePartialValidity(Solver::PartialValidity pv);
...
public:
  ...
  virtual Solver::PartialValidity computeValidity(const Query&);

  /// computeValidity - Compute a partial validity for the given query.
  ///
  /// The passed expression is non-constant with bool type.
  virtual Solver::PartialValidity computeTruth(const Query&) = 0;
